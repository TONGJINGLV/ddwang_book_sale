# Generated by Django 2.2.3 on 2019-12-30 18:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='bookstore.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='bookstore.Supplier')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchaseorder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookstore.Purchaseorder')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(default=0)),
                ('book', models.ForeignKey(limit_choices_to={'on_sale': 'Y'}, on_delete=django.db.models.deletion.PROTECT, to='bookstore.Book')),
